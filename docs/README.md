...
<details>
    <summary>지하철 노선에 등록된 역 조회 기능</summary>
    <div markdown="1">
...
<details>
    <summary>실행 결과 예시 - 노선 관리</summary>
    <div markdown="1">
...
<details>
    <summary>실행 결과 예시 - 구간 관리</summary>
    <div markdown="1">
...
<details>
    <summary>실행 결과 예시 - 지하철 노선도 출력</summary>
    <div markdown="1">
...
- [ ] 지하철역 - 교대역, 강남역, 역삼역, 남부터미널역, 양재역, 양재시민의숲역, 매봉역을 사전 등록하기
...
- [ ] 입력값 검증하기
  - [ ] `Exception` : 중복된 지하철 역 이름이 등록될 경우 예외 처리
  - [ ] `Exception` : 역 이름이 2글자 이하일 경우 예외 처리
  - [ ] `Exception` : 역 이름이 공백, 특수문자만으로 이루어지는 등 유효하지 않을 경우 예외 처리
- [ ] `OutputView` : 지하철 역 등록 완료 메시지 출력하기
- [ ] 첫 페이지로 돌아가기
...
- [ ] 입력값 검증하기
  ...
  - [ ] `Exception` : 노선 이름이 공백, 특수문자만으로 이루어지는 등 유효하지 않을 경우 예외 처리
  - [ ] `Exception` : 상행 종점역과 하행 종점역이 현재 노선에 없으면 예외 처리
- [ ] `OutputView` : 지하철 역 등록 완료 메시지 출력하기
- [ ] 메인 화면으로 돌아가기
